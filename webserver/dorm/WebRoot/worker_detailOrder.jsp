...
<html lang="en">
	...
	<div id="sidebar">
		...
		<ul>
			...
			<li class="active"><a href="OrderAction!WorkerCheckOrder"><i
			...
			<div class="container-fluid">
				...
				<div class="span12 center" style="text-align: center;">
					...
					<ul class="site-stats">
						...
						<li>报修人宿舍:<strong><s:property
									value="order.roomId" /> </strong><br>
						</li>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="OrderAction!workerUpdate" method="post" class="form-horizontal" />
									...
									<div class="control-group">
									      <div class="controls">
											<input type="submit" value="确认预约" class="btn btn-primary"/>
											</div>
									</div>
								</form>
							</div>
