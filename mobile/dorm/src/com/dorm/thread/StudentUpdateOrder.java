...
public class StudentUpdateOrder implements Runnable {
	...
	public StudentUpdateOrder(){}
	public StudentUpdateOrder(JOrder order,Handler handler){
	...
	public void run() {
		...
		try{
			...
			responseTis=ConnectService.connectService("http://192.168.0.100:8080/dorm/OrderJsonAction!updateOrder","orderJson",json);
			if(responseTis!=null){
