...
public class StudentRegister implements Runnable {
    ...
    public StudentRegister(Student student,Handler handler){
	...
	public void run() {
		...
		try{
			...
			responseTis=ConnectService.connectService("http://192.168.0.100:8080/dorm/StudentJsonAction!register","studentJson",json);
			if(responseTis!=null){
